  ...
  <main>
    ...
    <form action="{{$url}}" method="post" enctype="multipart/form-data" class="contact-form">
      ...
      <div class="form-group">
        ...
        <input type="file" id="imageFile" name="icons" accept="image/*" {{asset('icons/'.$service->icons)}}>
      </div>
      <div class="form-group">
        <label for="imageFile">Service-Title:</label>
        <input type="text" id="imageFile" name="title" value="{{$service->title}}">
      </div>
      <div class="form-group">
        <label for="imageFile">Service-Price:</label>
        <input type="text" id="imageFile" name="price" value="{{$service->price}}">
      </div>
      <div class="form-group">
